                ...
                <div class="card">
                    ...
                    <div class="form">
                        <el-form :model="registerForm">
                            <el-form-item>
                                <el-input :prefix-icon="User" v-model="registerForm.email" placeholder="请输入邮箱" clearable
                                    style="width: 16rem;">
                                </el-input>
                            </el-form-item>
                            <el-form-item>
                                <el-input :prefix-icon="User" v-model="registerForm.nickname" placeholder="请输入昵称"
                                    clearable style="width: 16rem;">
                                </el-input>
                            </el-form-item>
                            <el-form-item>
                            ...
                            <el-form-item>
                                <el-input :prefix-icon="Lock" type="password" v-model="registerForm.confirmPassword"
                                    placeholder="请确认密码" show-password clearable style="width: 16rem;">
                                </el-input>
                            </el-form-item>
                            <div class="buttons">
                                <el-button class="button" type="primary" @click="registerHandler()">注 册</el-button>
...
const registerHandler = async () => {
    if (!registerForm.email || !registerForm.nickname || !registerForm.password || !registerForm.confirmPassword) {
